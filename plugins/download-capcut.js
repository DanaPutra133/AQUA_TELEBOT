  ...
  init: async (bot, { buttonUrl, mess, api, apikey }) => {
    bot.onText(/^\/capcutdl(?: (.+))?$/, async (msg, match) => {
      ...
      try {
        ...
        bot.sendMessage(chatId, 'ada error saat mempreses link mu.', { reply_to_message_id: msg.message_id });
      }
    });
  },
};
